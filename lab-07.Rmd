...
ggplot(data.frame(evals), aes(x = score)) +
  geom_histogram(binwidth = 0.1, fill = "skyblue", color = "black") +
  labs(title = "Histogram of students' scores", x = "Scores", y = "Frequency")
...
- The distribution is skewed to 4.5 scores
...
ggplot(evals, aes(x = score, y = bty_avg)) +
  geom_point() +
  labs(title = "Relationship between score and bty_avg", x = "score", y = "bty_avg")
